...
function findAll(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const beneficiary = yield service_1.default.findAll(pageNo, pageSize);
...
function search(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const pageNo = req.query.pageNo ? parseInt(req.query.pageNo.toString()) - 1 : 0;
            const pageSize = req.query.pageSize ? parseInt(req.query.pageSize.toString()) : 20;
            const beneficiary = yield service_1.default.search(req.body, pageNo, pageSize);
...
function findOne(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const beneficiary = yield service_1.default.findOne(req.params.id);
...
function create(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const beneficiary = yield service_1.default.insert(req.body);
...
function update(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const beneficiary = yield service_1.default.update(req.params.id, req.body);
            if (beneficiary > 0) {
...
function remove(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const beneficiary = yield service_1.default.remove(req.params.id);
            res.status(200).json(beneficiary);
        }
        catch (error) {
            next(new error_1.HttpError(error.message.status, error.message));
