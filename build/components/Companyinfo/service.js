...
const CompanyinfoService = {
    ...
    */
    ...
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.getCompanyinfo({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
    ...
    insert(body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.createCompanyinfo(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const companyInfo = yield model_1.default.create(body);
                return companyInfo;
            }
            catch (error) {
                throw new Error(error.message);
    ...
    update(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.updateCompanyinfo(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const companyInfo = yield model_1.default.updateOne({ _id: mongoose_1.Types.ObjectId(id) }, { $set: body });
    ...
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.removeCompanyinfo({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const companyInfo = yield model_1.default.findOneAndRemove({
                    _id: mongoose_1.Types.ObjectId(id),
                });
                return companyInfo;
            }
...
exports.default = CompanyinfoService;
