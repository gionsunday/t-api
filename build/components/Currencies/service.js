...
const CurrenciesService = {
    ...
    */
    ...
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.getCurrencies({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
    ...
    insert(body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.createCurrencies(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const currencies = yield model_1.default.create(body);
                return currencies;
            }
            catch (error) {
                throw new Error(error.message);
    ...
    update(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.updateCurrencies(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const currencies = yield model_1.default.updateOne({ _id: mongoose_1.Types.ObjectId(id) }, { $set: body });
    ...
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.removeCurrencies({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const currencies = yield model_1.default.findOneAndRemove({
                    _id: mongoose_1.Types.ObjectId(id),
                });
                return currencies;
            }
...
exports.default = CurrenciesService;
