...
const KycdocumentsService = {
    ...
    */
    ...
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.getKycdocuments({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
    ...
    insert(body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.createKycdocuments(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const kycDocuments = yield model_1.default.create(body);
                return kycDocuments;
            }
            catch (error) {
                throw new Error(error.message);
    ...
    update(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.updateKycdocuments(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const kycDocuments = yield model_1.default.updateOne({ _id: mongoose_1.Types.ObjectId(id) }, { $set: body });
    ...
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.removeKycdocuments({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const kycDocuments = yield model_1.default.findOneAndRemove({
                    _id: mongoose_1.Types.ObjectId(id),
                });
                return kycDocuments;
            }
...
exports.default = KycdocumentsService;
