...
const StatisticsService = {
    ...
    */
    ...
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.getStatistics({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
    ...
    insert(body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.createStatistics(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const statistics = yield model_1.default.create(body);
                return statistics;
            }
            catch (error) {
                throw new Error(error.message);
    ...
    update(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.updateStatistics(body);
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const statistics = yield model_1.default.updateOne({ _id: mongoose_1.Types.ObjectId(id) }, { $set: body });
    ...
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validate = validation_1.default.removeStatistics({
                    id,
                });
                if (validate.error) {
                    throw new Error(validate.error.message);
                }
                const statistics = yield model_1.default.findOneAndRemove({
                    _id: mongoose_1.Types.ObjectId(id),
                });
                return statistics;
            }
