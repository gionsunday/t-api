 ...
 */
router.get('/', components_1.AnnouncementsComponent.findAll);
/**
 * POST method route
 ...
 *                $ref: '#/components/schemas/Error'
 */
router.post('/search', components_1.AnnouncementsComponent.search);
/**
 * POST method route
 * @example http://localhost:PORT/v1/announcements
 *
 ...
 *                $ref: '#/components/schemas/Error'
 */
router.post('/', components_1.AnnouncementsComponent.create);
/**
 * POST method route
 * @example http://localhost:PORT/v1/announcements
 *
 ...
 *                $ref: '#/components/schemas/Error'
 */
router.patch('/:id', components_1.AnnouncementsComponent.update);
/**
 * GET method route
 ...
 *                - $ref: '#/components/schemas/AnnouncementsSchema'
 */
router.get('/:id', components_1.AnnouncementsComponent.findOne);
/**
 * DELETE method route
 * @example  http://localhost:PORT/v1/announcements/:id
 *
 ...
 *                - $ref: '#/components/schemas/AnnouncementsSchema'
 */
router.delete('/:id', components_1.AnnouncementsComponent.remove);
/**
