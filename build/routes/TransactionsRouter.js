 ...
 */
router.get('/', components_1.TransactionsComponent.findAll);
/**
 * POST method route
 ...
 *                $ref: '#/components/schemas/Error'
 */
router.post('/search', components_1.TransactionsComponent.search);
/**
 * POST method route
 * @example http://localhost:PORT/v1/transactions
 *
 ...
 *                $ref: '#/components/schemas/Error'
 */
router.post('/', components_1.TransactionsComponent.create);
/**
 * POST method route
 * @example http://localhost:PORT/v1/transactions
 *
 ...
 *                $ref: '#/components/schemas/Error'
 */
router.patch('/:id', components_1.TransactionsComponent.update);
/**
 * GET method route
 ...
 *                - $ref: '#/components/schemas/TransactionsSchema'
 */
router.get('/:id', components_1.TransactionsComponent.findOne);
/**
 * DELETE method route
 * @example  http://localhost:PORT/v1/transactions/:id
 *
 ...
 *                - $ref: '#/components/schemas/TransactionsSchema'
 */
router.delete('/:id', components_1.TransactionsComponent.remove);
/**
