 ...
 */
export async function upload(req: RequestWithUser, res: Response, next: NextFunction): Promise<void> {
    try {
 ...
 * @returns {Promise <void>}
 */
export async function read(req: RequestWithUser, res: Response, next: NextFunction): Promise<void> {
    try {
